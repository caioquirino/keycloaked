...
public class EmailOtpAuthenticatorFactory implements AuthenticatorFactory {
    ...
    private static final ChannelOtpAuthenticator SINGLETON = new ChannelOtpAuthenticator("email");
    ...
    public String getHelpText() {
        return "Dispatches a 6-digit one-time code to the user's registered email address.";
    }
